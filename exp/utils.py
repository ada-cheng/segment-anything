...
from segment_anything.build_sam import sam_model_registry, create_sam_model_registry
from segment_anything.predictor import SamPredictor


sam_model_registry = create_sam_model_registry()
