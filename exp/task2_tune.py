...
if __name__ == '__main__':
    ...
    model_type = 'vit_h_adapter' if args.use_adapter else 'vit_h_train'
    
    sam = utils.get_sam(device=args.device, model_type='vit_h_adapter', sam_checkpoint='../sam.pth')
    optimizer_kwargs = {}
    ...
    torch.save(sam.state_dict(), '../sam_adapter_tune.pth')